...
public class Chessman : MonoBehaviour
{
    ...
    // References for all sprites that chesspiece can be
    ...
    public void PointMovePlate(int x, int y, bool isAttack = false)
    {
        Game sc = controller.GetComponent<Game>();
    ...
    public void PawnMovePlate(int x, int y, bool isAttack = false)
    {
        Game sc = controller.GetComponent<Game>();
        if (sc.PositionOnBoard(x, y))
        {
